...
const TOOLS: AnyTool[] = [
  ...
  { id: "VVEX54200", vendor: "A", frameType: "Type-Alpha", building: "A", col: "7", pos: 0, posTotal: 2,
    image: null,
    oneNote: { url: "#", name: "VVEX54200 Frame Overview" },
    chambers: [
      { id: "VVEX54200-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
      { id: "VVEX54200-B", label: "Chamber B", oneNote: { url: "#", name: "Chamber B Photos" } },
      { id: "VVEX54200-C", label: "Chamber C", oneNote: { url: "#", name: "Chamber C Photos" } },
    ]},
  { id: "TNYE50500", vendor: "B", frameType: "Type-Beta", building: "A", col: "7", pos: 1, posTotal: 2,
    image: null,
    oneNote: { url: "#", name: "TNYE50500 Frame Overview" },
    chambers: [
      { id: "TNYE50500-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
      { id: "TNYE50500-B", label: "Chamber B", oneNote: { url: "#", name: "Chamber B Photos" } },
    ]},
  { id: "VVEX54300", vendor: "A", frameType: "Type-Alpha", building: "A", col: "8", pos: 0, posTotal: 2,
    image: null,
    oneNote: { url: "#", name: "VVEX54300 Frame Overview" },
    chambers: [
      { id: "VVEX54300-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
      { id: "VVEX54300-B", label: "Chamber B", oneNote: { url: "#", name: "Chamber B Photos" } },
    ]},
  { id: "TNYE50600", vendor: "B", frameType: "Type-Beta", building: "A", col: "8", pos: 1, posTotal: 2,
    image: null,
    oneNote: { url: "#", name: "TNYE50600 Frame Overview" },
    chambers: [
      { id: "TNYE50600-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
    ]},

  // ── BUILDING B ──
  { id: "LRCE40100", vendor: "A", frameType: "Type-Alpha", building: "B", col: "4", pos: 0, posTotal: 1,
    image: null,
    oneNote: { url: "#", name: "LRCE40100 Frame Overview" },
    chambers: [
      { id: "LRCE40100-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
      { id: "LRCE40100-B", label: "Chamber B", oneNote: { url: "#", name: "Chamber B Photos" } },
      { id: "LRCE40100-C", label: "Chamber C", oneNote: { url: "#", name: "Chamber C Photos" } },
      { id: "LRCE40100-D", label: "Chamber D", oneNote: { url: "#", name: "Chamber D Photos" } },
    ]},
  { id: "TVEX10100", vendor: "B", frameType: "Type-Beta", building: "B", col: "12", pos: 0, posTotal: 3,
    image: null,
    oneNote: { url: "#", name: "TVEX10100 Frame Overview" },
    chambers: [
      { id: "TVEX10100-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
      { id: "TVEX10100-B", label: "Chamber B", oneNote: { url: "#", name: "Chamber B Photos" } },
    ]},
  { id: "TVEX10200", vendor: "B", frameType: "Type-Beta", building: "B", col: "12", pos: 1, posTotal: 3,
    image: null,
    oneNote: { url: "#", name: "TVEX10200 Frame Overview" },
    chambers: [
      { id: "TVEX10200-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
    ]},
  { id: "AALS20100", vendor: "C", frameType: "Type-Gamma", building: "B", col: "12", pos: 2, posTotal: 3,
    image: null,
    oneNote: { url: "#", name: "AALS20100 Frame Overview" },
    chambers: [
      { id: "AALS20100-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
    ]},
  { id: "LRCE40200", vendor: "A", frameType: "Type-Alpha", building: "B", col: "16", pos: 0, posTotal: 1,
    image: null,
    oneNote: { url: "#", name: "LRCE40200 Frame Overview" },
    chambers: [
      { id: "LRCE40200-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
      { id: "LRCE40200-B", label: "Chamber B", oneNote: { url: "#", name: "Chamber B Photos" } },
    ]},

  // ── BUILDING C ──
  { id: "LSTA10100", vendor: "A", frameType: "Type-Delta", building: "C", col: "10", pos: 0, posTotal: 1, image: null,
    oneNote: { url: "#", name: "LSTA10100 Frame Overview" },
    chambers: [
      { id: "LSTA10100-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
      { id: "LSTA10100-B", label: "Chamber B", oneNote: { url: "#", name: "Chamber B Photos" } },
    ]},
  { id: "TVEX20100", vendor: "B", frameType: "Type-Beta", building: "C", col: "21", pos: 0, posTotal: 3, image: null,
    oneNote: { url: "#", name: "TVEX20100 Frame Overview" },
    chambers: [
      { id: "TVEX20100-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
    ]},
  { id: "LVEX20200", vendor: "A", frameType: "Type-Alpha", building: "C", col: "21", pos: 1, posTotal: 3, image: null,
    oneNote: { url: "#", name: "LVEX20200 Frame Overview" },
    chambers: [
      { id: "LVEX20200-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
      { id: "LVEX20200-B", label: "Chamber B", oneNote: { url: "#", name: "Chamber B Photos" } },
    ]},
  { id: "AVEX20300", vendor: "C", frameType: "Type-Gamma", building: "C", col: "21", pos: 2, posTotal: 3, image: null,
    oneNote: { url: "#", name: "AVEX20300 Frame Overview" },
    chambers: [
      { id: "AVEX20300-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
    ]},
  { id: "LRTR11100", vendor: "A", frameType: "Type-Alpha", building: "C", col: "24", pos: 0, posTotal: 3, image: null,
    oneNote: { url: "#", name: "LRTR11100 Frame Overview" },
    chambers: [
      { id: "LRTR11100-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
      { id: "LRTR11100-B", label: "Chamber B", oneNote: { url: "#", name: "Chamber B Photos" } },
    ]},
  { id: "TRTR11200", vendor: "B", frameType: "Type-Beta", building: "C", col: "24", pos: 1, posTotal: 3, image: null,
    oneNote: { url: "#", name: "TRTR11200 Frame Overview" },
    chambers: [
      { id: "TRTR11200-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
    ]},
  { id: "LV4T10100", vendor: "A", frameType: "Type-Alpha", building: "C", col: "24", pos: 2, posTotal: 3, image: null,
    oneNote: { url: "#", name: "LV4T10100 Frame Overview" },
    chambers: [
      { id: "LV4T10100-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
      { id: "LV4T10100-B", label: "Chamber B", oneNote: { url: "#", name: "Chamber B Photos" } },
    ]},
  { id: "TV4T10200", vendor: "B", frameType: "Type-Beta", building: "C", col: "27", pos: 0, posTotal: 3, image: null,
    oneNote: { url: "#", name: "TV4T10200 Frame Overview" },
    chambers: [
      { id: "TV4T10200-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
    ]},
  { id: "LV4T10300", vendor: "A", frameType: "Type-Alpha", building: "C", col: "27", pos: 1, posTotal: 3, image: null,
    oneNote: { url: "#", name: "LV4T10300 Frame Overview" },
    chambers: [
      { id: "LV4T10300-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
    ]},
  { id: "AV4T10400", vendor: "C", frameType: "Type-Gamma", building: "C", col: "27", pos: 2, posTotal: 3, image: null,
    oneNote: { url: "#", name: "AV4T10400 Frame Overview" },
    chambers: [
      { id: "AV4T10400-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
    ]},
  { id: "LRLT10100", vendor: "A", frameType: "Type-Delta", building: "C", col: "38", pos: 0, posTotal: 1, image: null,
    oneNote: { url: "#", name: "LRLT10100 Frame Overview" },
    chambers: [
      { id: "LRLT10100-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
    ]},
  { id: "TEZ410100", vendor: "B", frameType: "Type-Beta", building: "C", col: "41", pos: 0, posTotal: 1, image: null,
    oneNote: { url: "#", name: "TEZ410100 Frame Overview" },
    chambers: [
      { id: "TEZ410100-A", label: "Chamber A", oneNote: { url: "#", name: "Chamber A Photos" } },
      { id: "TEZ410100-B", label: "Chamber B", oneNote: { url: "#", name: "Chamber B Photos" } },
    ]},
];
  ...
  const content = (
    <>
      ...
      <div style={{ padding: m ? "12px 20px 14px" : "16px 20px 12px", borderBottom: `1px solid ${T.border}` }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 13, color: T.textMuted, marginTop: 3 }}>{tool.frameType} · {CONFIG.buildings[tool.building].label}</div>
          </div>
      ...
      <div style={{ padding: m ? "0 20px 24px" : "0 20px 20px" }}>
        ...
        <NoteLnk link={tool.oneNote} m={m} />
        {(tool.chambers || []).map((ch: AnyTool) => (
          <div key={ch.id}>
            <Sec>{ch.label} — {ch.id}</Sec>
            <NoteLnk link={ch.oneNote} m={m} />
          </div>
        ))}
        <div style={{ marginTop: 16, background: T.bgAlt, border: `1px solid ${T.borderLight}`, borderRadius: 6, padding: "10px 12px", fontSize: 11, color: T.textMuted, lineHeight: 1.6 }}>
          <span style={{ color: T.textFaint, fontWeight: 600 }}>Tip:</span> {CONFIG.oneNoteTip}
        </div>
      </div>
    </>
  );
      ...
      {ht && (
        <div style={{ position: "fixed", left: hp.x + 16, top: hp.y - 6, background: "#ffffffee", border: `1px solid ${T.border}`, borderRadius: 8, padding: 0, minWidth: 220, maxWidth: 300, pointerEvents: "none", zIndex: 300, boxShadow: "0 4px 16px rgba(0,0,0,0.12)", overflow: "hidden" }}>
          ...
          <div style={{ padding: "10px 14px" }}>
            ...
            <div style={{ fontSize: 12, color: T.textMuted }}>{CONFIG.buildings[ht.building].label}</div>
      ...
      <div ref={this._rootRef} style={{ fontFamily: "'Segoe UI', 'Segoe UI Web (West European)', -apple-system, sans-serif", background: T.bg, color: T.text, display: "flex", flexDirection: "column", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 20px", borderBottom: `1px solid ${T.border}`, background: T.bgAlt, flexWrap: "wrap", gap: 8 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{ fontSize: 13, color: T.textMuted }}>Welcome, <span style={{ fontWeight: 600, color: T.text }}>{this.props.userDisplayName || "Tech"}</span></div>
        ...
        {/* Vendor legend + hint */}
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 20px", borderBottom: `1px solid ${T.borderLight}`, flexWrap: "wrap", gap: 6 }}>
          ...
          <div style={{ fontSize: 11, color: T.textFaint, fontStyle: "italic" }}>Click a tool to view its OneNote page</div>
        </div>
